...
//   background:#efefef;
  ...
  background-image: url('/static/img/webBg.jpg');
//   background: transparent;
  background-size: 100% 100%;
//   background-position: center;
//   background-repeat:space;
  background-attachment:fixed;
//   height: 1000px; /* 设置高度为视窗高度，使背景图片充满整个视窗 */
  font-size:14px;
  color:#444!important;
//   min-height:100vh;
//   width:100%;
...
.tcommonBox2 section p{
    line-height: 24px;
    margin:10px 0;
}
.tcommonBox2  header h2 .el-rate,.rateBox{
    display:inline-block;
}
.tcommonBox2  header h2 .el-rate i{
    font-size: 16px;
}
